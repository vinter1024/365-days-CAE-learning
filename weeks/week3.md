...
- [x] 工具箱
1. 分析系统
包含不同类型的分析，比如模态分析，点击后就打开模态分析的整套流程
...
## Day 17 流体有限元分析前处理知识1

- [x] workbench 界面设置

Tools-> options 打开设置界面 第二项界面设置
对各种类型边颜色的调整
1.  显示背景设置
2.  语言环境设置
3.  快捷键设置
